...
const ColorScheme = () => {
    ...
    return (
        <Fragment>
            <h5 className="mb-3 fs-16 fw-bold">Esquema de color</h5>
            <Row>
                {modes.map((item, idx) => (
                    <Col xs={4} key={item.mode + idx}>
                        ...
                        <h5 className="fs-14 text-center text-muted mt-2 ">{item.label}</h5>
                    </Col>
                ))}
            </Row>
        </Fragment>
...
const OrientationScheme = () => {
    ...
    return (
        <>
            <h5 className="mb-3 fs-16 fw-bold">Tipo de layout</h5>
            <Row>
                {modes.map((item, idx) => (
                    <Col xs={4} key={item.mode + idx}>
                        <div className="form-check card-radio">
        ...
        <>
            ...
            <Row>
                ...
                <Col xs={4}>
                    ...
                    <h5 className="fs-14 text-center text-muted mt-2">Separado</h5>
                </Col>
            </Row>
        </>
    );
...
const TopbarTheme = () => {
    ...
    const modes: Array<{ mode: TopBarThemeType; label: string }> = [
        { mode: 'light', label: 'Claro' },
        { mode: 'dark', label: 'Oscuro' },
        { mode: 'brand', label: 'Marca' },
    ];
    return (
        <>
            <h5 className="mb-3 fs-16 fw-bold">Color de la barra superior</h5>
            <Row>
...
const MenuTheme = () => {
    ...
    const modes: Array<{ mode: MenuThemeType; label: string }> = [
        { mode: 'light', label: 'Claro' },
        { mode: 'dark', label: 'Oscuro' },
        { mode: 'brand', label: 'Marca' },
    ];
    return (
        <>
            <h5 className="mb-3 fs-16 fw-bold">Color del menu</h5>
            <Row>
                {modes.map(({ mode, label }, idx) => (
                    <Col xs={3} key={idx}>
                        <div className="form-check sidebar-setting card-radio">
...
const SidebarSize = () => {
    ...
    return (
        <>
            <h5 className="mb-3 fs-16 fw-bold">Tamano de la barra lateral</h5>
            <Row>
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input
                    ...
                    <h5 className="fs-14 text-center text-muted mt-2">Predeterminado</h5>
                </Col>
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input
                ...
                <Col xs={4}>
                    ...
                    <h5 className="fs-14 text-center text-muted mt-2">Vista al pasar</h5>
                </Col>
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input
                    ...
                    <h5 className="fs-14 text-center text-muted mt-2">Layout completo</h5>
                </Col>
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input
                    ...
                    <h5 className="fs-14 text-center text-muted mt-2">Oculto</h5>
                </Col>
            </Row>
        </>
    );
        ...
        <>
            <Offcanvas show={open} onHide={toggle} placement="end" className="offcanvas-end" tabIndex={-1} id="theme-settings-offcanvas">
                <OffcanvasHeader className="d-flex align-items-center gap-2 px-3 py-3 border-bottom border-dashed">
                    <h5 className="flex-grow-1 mb-0">Configuracion del tema</h5>
                    <button type="button" onClick={toggle} className="btn-close" data-bs-dismiss="offcanvas" aria-label="Cerrar" />
                </OffcanvasHeader>
