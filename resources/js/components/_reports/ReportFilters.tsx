...
const ReportFilters = ({
    ...
    const handleDateRangeChange = (dates, dateStr) => {
    ...
    const statusLabel = (() => {
        switch (Number(statusFilter)) {
            ...
            case 5:
                return "Rechazado";
            case 7:
                return "Aprobado comite";
            case 8:
                return "Rechazado comite";
            default:
                return "Todos";
        }
    })();
                ...
                <IconifyIcon icon="tabler:adjustments" className="text-muted" />
                  {statusLabel}
                        ...
                        <Dropdown.Menu className="w-100">
                            ...
                            <Dropdown.Item onClick={() => handleStatusChange(7)}>
                                <div className="d-flex align-items-center justify-content-between">
                                    <span>Aprobado comite</span>
                                    {Number(statusFilter) === 7 && <span>✓</span>}
                                </div>
                            </Dropdown.Item>

                            <Dropdown.Item onClick={() => handleStatusChange(8)}>
                                <div className="d-flex align-items-center justify-content-between">
                                    <span>Rechazado comite</span>
                                    {Number(statusFilter) === 8 && <span>✓</span>}
                                </div>
                            </Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
